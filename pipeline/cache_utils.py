...
# Cache key
# ----------------------------
def _safe_stem(video_path: str, cache_key: Optional[str] = None) -> str:
    """
...
# Cached paths
# ----------------------------
def cached_pose_path(video_path: str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
    return os.path.join(base_dir, "poses", _safe_stem(video_path, cache_key) + "_filtered.csv")

def cached_kin_path(video_path: str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
    return os.path.join(base_dir, "kinematics", _safe_stem(video_path, cache_key) + "_kinematics.csv")

def cached_beh_path(video_path: str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
    return os.path.join(base_dir, "behavior", _safe_stem(video_path, cache_key) + "_behavior.csv")

def cached_outvideo_path(video_path: str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
    return os.path.join(base_dir, "videos", _safe_stem(video_path, cache_key) + "_annotated.mp4")

def cached_turn_path(video_path: str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
    return os.path.join(
        base_dir,
        "kinematics",
        _safe_stem(video_path, cache_key) + "_turning_rate.csv"
    )
def cached_nop_path(video_path: str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
    return os.path.join(base_dir, "nop", _safe_stem(video_path, cache_key) + "nop_summary.csv")

def cached_ml_features(video_path:str, base_dir: str = "outputs", cache_key: Optional[str] = None) -> str:
